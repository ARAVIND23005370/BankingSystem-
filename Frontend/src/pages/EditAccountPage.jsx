  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-4">
        <button onClick={() => navigate(`/accounts/${id}`)} className="text-stone-500 hover:text-stone-300 text-sm transition-colors">← Back</button>
        <div>
          <h2 className="text-2xl font-bold text-white">Edit Account</h2>
          <p className="text-stone-500 text-sm mt-0.5">Update account #{String(id).padStart(4, '0')} details</p>
        </div>
      </div>
