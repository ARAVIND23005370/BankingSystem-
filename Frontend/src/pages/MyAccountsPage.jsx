  ...
  return (
    <div className="max-w-5xl space-y-6">
      <div>
        ...
        <p className="text-stone-500 text-sm mt-1">All bank accounts linked to you</p>
      </div>
      ...
      {loading ? (
        ...
        <Card>
          <div className="text-center py-12">
            <p className="text-stone-500 text-lg mb-2">No accounts linked to you</p>
            <p className="text-stone-600 text-sm">Contact your administrator to create and assign an account to your email.</p>
          </div>
        </Card>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {list.map((acct) => (
            ...
            >
              ...
              <p className="text-stone-600 text-xs font-mono mb-3">#{String(acct.accountNumber || acct.id).padStart(4, '0')}</p>
              <p className="text-amber-400 font-mono text-lg font-bold">{formatCurrency(acct.balance)}</p>
