  ...
  return (
    <div className="min-h-screen bg-[#0f0f13] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -right-32 w-[500px] h-[500px] bg-amber-500/[0.07] rounded-full blur-3xl animate-float-1" />
        <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] bg-rose-500/[0.06] rounded-full blur-3xl animate-float-2" />
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[400px] h-[400px] bg-violet-500/[0.04] rounded-full blur-3xl animate-float-3" />
        <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-rose-400/[0.03] rounded-full blur-3xl animate-float-4" />
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-400 to-rose-400 flex items-center justify-center text-slate-950 font-bold text-3xl mx-auto mb-4 shadow-2xl animate-glow-pulse-gold">
            N
          </div>
        ...
        <div className="glass-premium rounded-3xl p-8 animate-border-glow">
          ...
          <p className="text-stone-500 text-sm mb-6">Register for a new account</p>
