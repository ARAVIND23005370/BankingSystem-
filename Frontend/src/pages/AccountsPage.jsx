    ...
    <div className="max-w-5xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-stone-500 text-sm mt-1">Manage your bank accounts</p>
        </div>
      ...
      {loading ? (
        ...
        <Card>
          <div className="text-center py-12">
            <p className="text-stone-500 text-lg mb-2">No accounts found</p>
            <p className="text-stone-600 text-sm mb-4">Get started by creating your first account</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {list.map((acct) => (
            ...
            >
              ...
              <p className="text-stone-600 text-xs font-mono mb-3">#{String(acct.id).padStart(4, '0')}</p>
